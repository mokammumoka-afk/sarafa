...
export default function AdminTicketDetail() {
  ...
  return (
    <div className="space-y-3">
      <Link to="/admin/support" className="inline-flex items-center gap-1 text-sm text-zinc-500 hover:text-accent-400"><ChevronRight size={16} /> رجوع لتذاكر الدعم</Link>
